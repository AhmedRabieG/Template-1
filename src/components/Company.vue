    ...
    <div class="company mb-2.5 pt-[80px]">
        <div class="container">
            ...
            <div class="grid grid-cols-3 gap-x-11 gap-y-6">
                ...
                <div class="p-[24px] border-[1px] border-solid border-[#EAEBEF] line-clamp-3 rounded-[12px]">
                    <p class="mb-[25px] text-[13px] pe-[36px]"> 
                        “Customers will not download an extra app for
                        pharmacies or the e-prescription. In my opinion,
                ...
                <div class="p-[24px] border-[1px] border-solid border-[#EAEBEF] line-clamp-3 rounded-[12px]">
                    <p class="mb-[25px] text-[13px] pe-[36px]"> 
                        “We can map our entire sales process in Superchat's
                        messaging software. We have a separate mailbox for
                ...
                <div class="p-[24px] border-[1px] border-solid border-[#EAEBEF] line-clamp-3 rounded-[12px]">
                    <p class="mb-[25px] text-[13px] pe-[36px] line-clamp-3"> 
                        “Our communication has been more efficient, simpler
                        and clearer since the implementation of Superchat.
                        Incoming customer inquiries are directly assigned to
                ...
                <div class="p-[24px] border-[1px] border-solid border-[#EAEBEF] line-clamp-3 rounded-[12px]">
                    <p class="mb-[25px] text-[13px] pe-[36px] line-clamp-3"> 
                        “What was promised by Superchat has been
                        delivered. Our employees are thrilled with the
                        messaging platform.”
                    </p>
                    <div class="flex gap-[12px]">
                ...
                <div class="p-[24px] border-[1px] border-solid border-[#EAEBEF] line-clamp-3 rounded-[12px]">
                    <p class="mb-[25px] text-[13px] pe-[36px] line-clamp-3"> 
                        “With Superchat and the WhatsApp newsletter, we
                        are much closer to our customers than with an email
                        newsletter.”
                    </p>
                    <div class="flex gap-[12px]">
                ...
                <div class="p-[24px] border-[1px] border-solid border-[#EAEBEF] line-clamp-3 rounded-[12px]">
                    <p class="mb-[25px] text-[13px] pe-[36px] line-clamp-3"> 
                        “Communication with our customers is much easier,
                        faster and more modern. Superchat is even used in
                        the HR department.”
                    </p>
                    <div class="flex gap-[12px]">
                ...
                <div class="p-[24px] border-[1px] border-solid border-[#EAEBEF] line-clamp-3 rounded-[12px]">
                    ...
                    <div class="flex gap-[12px]">
                        ...
                        <div class="">
                            ...
                            <p class="text-[11px] text-[#90909B]">KRF (KinderRechteForum)</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-[24px] border-[1px] border-solid border-[#EAEBEF] line-clamp-3 rounded-[12px]">
                    <p class="mb-[25px] text-[13px] pe-[36px] line-clamp-3"> 
                        “Superchat has helped us bring system and order to
                        our customer communications. Fewer chats are lost
                        and we can work together as a team on social media
                ...
                <div class="p-[24px] border-[1px] border-solid border-[#EAEBEF] line-clamp-3 rounded-[12px]">
                    <p class="mb-[25px] text-[13px] pe-[36px] line-clamp-3"> 
                        “Superchat is the central building block in customer
                        communication for us. WhatsApp provides us as an
