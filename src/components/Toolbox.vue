...
<template>
  <div class="toolbox pb-[80px] bg-[#F7F8FA]">
    <div class="container">
      <div>
        <div
          class="text-center mt-[80px] mb-[56px] w-[576px] m-auto"
        >
        ...
        <div class="toolbox__content flex gap-[104px]">
          <div class="w-[50%]">
            <div
              class="flex mb-4 ps-6 pe-8 pb-[21px] pt-6 gap-5 bg-[#fff] rounded-[12px] border-[1px] border-solid"
            >
              ...
              <div class="text-[#7D7D8A] accordion-container">
                <button
                  type="button"
                  class="accordion Aeonik-font font-medium text-[20px] w-full text-start"
                >
            ...
            <div
              class="flex mb-5 ps-6 pe-8 pb-[21px] pt-6 gap-5 bg-[#fff] rounded-[12px] border-[1px] border-solid"
            >
              <svg class="shrink-0" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div
              class="flex ps-6 pe-8 py-6 pb-[21px] pt-6 gap-5 bg-[#fff] rounded-[12px] border-[1px] border-solid"
            >
              <svg class="shrink-0" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
